        ...
        <Page size="A4">
          <View style={styles.direccion}>
            <View style={styles.caja}>
              ...
              <Text style={styles.ND}>NOTA DE DEBITO</Text>
            </View>
            <View style={styles.caja2}>
              <Text style={styles.membrete}>{datosM.operador ? datosM.operador : datosM.operador}</Text>
              ...
              {!loading ? (
                ...
                <Text style={styles.membrete2}>N°de CONTROL ND-{pad(idp, 0, 6)}</Text>
              )}
          ...
          <View style={styles.caja5}>
            <Text>
              <Text>{datosM.id_servicio} - {datosM.concepto_servicio}</Text>
              <Text style={styles.monto}>
                {
                  "                                                                                                                            "
                }
          ...
          <View style={styles.caja5}>
            <Text>
              ...
              <Text>{"            "}16%</Text>
              <Text>{"                   "}{datosM.monto_total ? Number(datosM.monto_total).toFixed(2) : ''}</Text>
              <Text>{"                                         "}0,00</Text>
              <Text>
                {"                                                "}
                {datosM.monto_iva}
          ...
          <View style={styles.caja4}>
            <Text style={styles.monto2}>{datosM.monto_total ? (Number(datosM.monto_total) + Number(datosM.monto_iva)).toFixed(2) :  datosM.total_2 ? datosM.total_2.toFixed(2):''  }</Text>
          </View>
...
{/*           <View style={styles.caja7}>
            ...
            <View style={{textAlign:"center"}}>
                <Text style={styles.piepagina}>
                  ...
                  <Text style={{textAlign:'center',fontSize: "9px"}}>ORIGINAL</Text>
            </View>
        </Page>
      </Document>
    </PDFViewer>
