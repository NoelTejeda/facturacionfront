...
//import { direccionOperador } from "../../utils/funciones"
import {
  Document,
  Page,
  View,
...
export default function PdfPreFacturaComercial(props) {
  ...
  // const direccion = direccionOperador(datosM.rif)
          ...
          <Page size="A4">
            <View style={styles.direccion}>
              ...
              <View style={styles.caja2}>
                <Text style={styles.membrete}>{datosM.operador ? datosM.operador : ''}</Text>
                ...
                {!loading ? (
                  ...
                  <Text style={styles.membrete2}>N°de CONTROL PF-{pad(idp, 0, 6)}</Text>
                )}
                {datosM.approval !== 'Aprobada' || 'Rechazada' ? <Text style={styles.prefactura}>PREFACTURA</Text> : ''}

                {datosM.approval === 'Aprobada' ? <Text style={styles.prefacturaAprobada}>APROBADA</Text> : ''}
                {datosM.approval === 'Rechazada' ? <Text style={styles.prefactura}>RECHAZADA</Text> : ''}
            ...
            <Text>
              ...
              <Text>{"            "}16%</Text>
              <Text>{"                   "}{datosM.total_mount ? datosM.total_mount.toFixed(2) : ''}</Text>
              <Text>{"                                         "}0,00</Text>
              <Text>
                {"                                             "}
                {datosM.iva}
            ...
            <View style={styles.caja4}>
              <Text style={styles.monto2}>{datosM.total_mount ? (Number(datosM.total_mount.toFixed(2)) + Number(datosM.iva.toFixed(2))).toFixed(2) : datosM.total_2 ? datosM.total_2.toFixed(2) : ''} Bs</Text>
            ...
            <View style={styles.caja7}>
              ...
              <View style={styles.caja7}>
                ...
                {/*                 <Text style={styles.original}>
                  {datosM.approval === 'Aprobada' ? <Text style={styles.prefacturaAprobada}>Original</Text> : ''}
                  {datosM.approval === 'Rechazada' ? <Text style={styles.prefactura}>Rechazada</Text> : ''}
                </Text> */}
